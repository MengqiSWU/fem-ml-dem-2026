...
sys.path.insert(1,'/home/mengqi/yade/install/lib/x86_64-linux-gnu/yade-2022-08-19.git-e3bd676/py')

# get yade path (allow YADE_PREFIX to override)
prefix,suffix='/home/mengqi/yade/install' if 'YADE_PREFIX' not in os.environ else os.environ['YADE_PREFIX'],'-2022-08-19.git-e3bd676'
# duplicate some items from yade.config here, so that we can increase verbosity when the c++ part is booting
features,version,debugbuild=' LOGGER USEFUL_ERRORS COMPLEX_MP VTK OPENMP GTS QT5 CGAL PFVFLOW PFVFLOW LINSOLV MPI TWOPHASEFLOW LS_DEM FEMLIKE GL2PS LBMFLOW THERMAL PARTIALSAT POTENTIAL_PARTICLES POTENTIAL_BLOCKS'.split(' '),'2022-08-19.git-e3bd676',' '

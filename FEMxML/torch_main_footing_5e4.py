...
if __name__ == '__main__':
    ...
    data_paths = [
        # biaxial
        '../../simu/footing_0.05/footing_0.05_implicit_dem_intorder1_numg640_x16_y10_surcharge_60e3_2.0*3.6m_4.5%strain_blk0.45_fric0.15_400ball_p0.2_Y3e8_modified2/iteration_gauss',

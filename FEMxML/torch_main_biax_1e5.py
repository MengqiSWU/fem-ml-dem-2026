...
if __name__ == '__main__':
    ...
    data_paths = [
        ...
        '../../simu/explicit/retaining/retaining_explicit_mixed_intorder1_numg271_retaining_321_vel0.10_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_csuh_all_ocr377_1_timestep4.0e-04/added_points',
        '../../simu/explicit/retaining/retaining_explicit_mixed_intorder1_numg271_retaining_321_vel0.10_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_csuh_all_ocr377_2_timestep4.0e-04/added_points',
        '../../simu/explicit/retaining/retaining_explicit_mixed_intorder1_numg271_retaining_321_vel0.10_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_csuh_all_ocr377_3_timestep4.0e-04/added_points',
        # #footing
        ...
        # '../../simu/explicit/retaining/retaining_explicit_mixed_order1_numg271_retaining_321_vel0.40_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_von_all_2/added_points',
        # '../../simu/explicit/retaining/retaining_explicit_mixed_order1_numg271_retaining_321_vel0.40_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_von_all_3/added_points',
        # '../../simu/explicit/retaining/retaining_explicit_mixed_order1_numg271_retaining_321_vel0.40_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_von_all_0/added_points',
        # '../../simu/explicit/retaining/retaining_explicit_mixed_order1_numg271_retaining_321_vel0.40_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_von_all_1/added_points',
        ...
        # '../../simu/explicit/footing/footing_explicit_mixed_order1_numg254_footing303_vel0.40_damp1.0e+06_safe0.5_NNX_epsANDabsxy_Y_sig_dd20_Fourier_noRotate_von_all_3/added_points',
    ...
    while i < n_args:
        if arg_list[i] == '-n':
            ...
            i += 1
    if input_n == None:
        special_str = 'csuh_all_ocr377_%d' % (len(data_paths)//3)
    else:
        special_str = 'csuh_all_ocr377_%d' % (input_n)
        data_paths_temp = []
        for i in range(3):
    ...
    for layers_name in layer_list:
        for node_num in [20]:
            for fourier_features in [True]:
                input_features = 'epsANDabsxy'  # 'epsANDH' epsANDqH epsANDpqH
                output_features = 'sig'

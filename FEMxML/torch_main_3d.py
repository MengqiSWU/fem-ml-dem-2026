...
from FEMxML.utils_ml_3d import \
    get_data_3d, findDevice, pickle_load, check_mkdir, save_scalar, reconstruct_x_y, sampling_index, sampling_index_3D
...
def train_main_def(
        ...
        layerList='dd',
        node_num=20,
        fourier_features=False, epoch_max=int(1e5), numSamplesUsed=None, manual = False,
    ...
    index = sampling_index_3D(x_data, sample_num=numSamplesUsed, ratio=sample_ratio, iteration=iteration, numg=numg, manual=manual)

from FEMxML.utils_ml_3d import *
...
#### predict mesh 10*20
returned_dict_dem = get_data_series(
    root_path_list=['../../simu/Triaxial_Reld2/Plot_curves/biax_3d_rough_implicit_dem3d_intorder1_numg432_x3_y3_Y4e8_fri0.5_p0.3_n1000_rM01_Denser_accum_modified/iteration_gauss'],
    numg=432)
returned_dict_ml = get_data_series(
    root_path_list=[
        '../../simu/Triaxial_Reld2/Plot_curves/biax_3d_rough_implicit_mldem3d_intorder1_numg432_x3_y3_Y4e8_fri0.5_p0.3_rM01_n1000_accum_rotation_reld_with_Gaussian_points/iteration_gauss'],
    numg=432)
...
strain_dem, stress_dem,  = returned_dict_dem['eps'], returned_dict_dem['sig']

strain_ml, stress_ml, = returned_dict_ml['eps'], returned_dict_ml['sig']
...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[417, ::5, 0], stress1[417, ::5, 0] / 1000000, linestyle='-', color='#D071FF', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[3, ::5, 0], stress1[3, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[417, ::7, 0], stress2[417, ::7, 0] / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='none',
    ...
    ax.legend(loc=(0.25, 0.7), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_11_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[407, ::5, 1] , stress1[407, ::5, 1]  / 1000000, linestyle='-', color='#D071FF', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[407, ::7, 1] , stress2[407, ::7, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
    ...
    ax.legend(loc=(0.2, 0.2), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_12_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case13(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_ylim([-0.002, 0.03])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{13}$',fontsize =12)
    ax.set_ylabel('$\sigma_{13}$ (MPa)',fontsize =12)

    ax.plot(strain1[127, ::5, 2] , stress1[127, ::5, 2]  / 1000000, linestyle='-', color='#D071FF', linewidth=3., label='$\sigma_{13}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[127, ::7, 2] , stress2[127, ::7, 2]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1., label='$\sigma_{13}-ML$')
    # ax.plot(strain2[3, ::5, 1], stress2[3, ::5, 1] / 1000000, linestyle='-', color='black', marker='o',
    #         markerfacecolor='None', markersize=4, linewidth=1,)

    ax.legend(loc=(0.2, 0.2), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_13_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[127, ::5, 3] , stress1[127, ::5, 3] / 1000000, linestyle='-', color='#D071FF', linewidth=3., label='$\sigma_{22}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[127, ::7, 3] , stress2[127, ::7, 3] / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
    ...
    ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_22_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case23(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_xlim([-0.016, 0.0011])
    # ax.set_ylim([-0.35, -0.1])
    ax.set_xlabel('$\epsilon_{23}$',fontsize =12)
    ax.set_ylabel('$\sigma_{23}$ (MPa)',fontsize =12)

    ax.plot(strain1[117, ::5, 4] , stress1[117, ::5, 4] / 1000000, linestyle='-', color='#D071FF', linewidth=3, label='$\sigma_{23}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[117, ::7, 4] , stress2[117, ::7, 4] / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{23}-ML$')
    # ax.plot(strain2[3, ::5, 2], stress2[3, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_23_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case33(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_xlim([-0.016, 0.0011])
    # ax.set_ylim([-0.35, -0.1])
    ax.set_xlabel('$\epsilon_{33}$',fontsize =12)
    ax.set_ylabel('$\sigma_{33}$ (MPa)',fontsize =12)

    ax.plot(strain1[127, ::5, 5] , stress1[127, ::5, 5] / 1000000, linestyle='-', color='#D071FF', linewidth=3, label='$\sigma_{33}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[127, ::7, 5] , stress2[127, ::7, 5] / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{33}-ML$')
    # ax.plot(strain2[3, ::5, 2], stress2[3, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2,fontsize =14)
    pyplot.savefig('./NO200_33_coarse_3D_invited.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
plot_case13(strain_dem, strain_ml, stress_dem, stress_ml, indexOfPoint)
plot_case22(strain_dem, strain_ml, stress_dem, stress_ml, indexOfPoint)
plot_case23(strain_dem, strain_ml, stress_dem, stress_ml, indexOfPoint)
plot_case33(strain_dem, strain_ml, stress_dem, stress_ml, indexOfPoint)

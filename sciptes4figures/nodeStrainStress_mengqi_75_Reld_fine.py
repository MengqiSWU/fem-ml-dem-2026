...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    x_major_locator = MultipleLocator(0.0006)
    ...
    pyplot.xlim([-0.0002, 0.0035])
    ax.set_ylim(-0.135, -0.095)
    ...
    ax.plot(strain1[5, ::5, 0], stress1[75, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[3, ::5, 0], stress1[3, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[5, ::5, 0], stress2[75, ::5, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    ...
    pyplot.savefig('./NO75_11_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[0, ::5, 1] , stress1[75, ::5, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[0, ::5, 1] , stress2[75, ::5, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO75_12_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    #
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlim([-0.024, 0.002])
    ax.set_ylim([-0.36, -0.08])
    ax.set_xlabel('$\epsilon_{22}$',fontsize =12)
    ax.set_ylabel('$\sigma_{22}$ (MPa)',fontsize =12)

    ax.plot(strain1[0, ::5, 2] , stress1[75, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[0, ::5, 2] , stress2[75, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO75_22_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

...
def plot_case11(strain1,  stress1, indexOfPoint):
    ...
    pyplot.savefig('./strain11.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, stress1, indexOfPoint):
    ...
    pyplot.savefig('./strain12.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, stress1, indexOfPoint):
    ...
    pyplot.savefig('./strain22.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()


x = np.arange(0, 800, 10)
indexOfPoint = list(x[0:30])

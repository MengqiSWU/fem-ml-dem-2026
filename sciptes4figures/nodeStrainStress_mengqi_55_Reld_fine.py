...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[0, ::5, 0], stress1[52, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[3, ::5, 0], stress1[3, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[0, ::5, 0], stress2[52, ::5, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    ...
    ax.legend(loc=(0.3, 0.7), frameon=True, fontsize =12, ncol=2)
    pyplot.savefig('./NO55_11_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.set_ylim([-0.024, 0.004])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{12}$',fontsize =12)
    ax.set_ylabel('$\sigma_{12}$ (MPa)',fontsize =12)

    ax.plot(strain1[0, ::5, 1] , stress1[45, ::5, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[0, ::5, 1] , stress2[45, ::5, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO55_12_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.set_ylim([-0.32, -0.08])
    ax.set_xlabel('$\epsilon_{22}$',fontsize =12)
    ax.set_ylabel('$\sigma_{22}$ (MPa)',fontsize =12)

    ax.plot(strain1[0, ::5, 2] , stress1[52, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[0, ::5, 2] , stress2[52, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO55_22_Reld_fine.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

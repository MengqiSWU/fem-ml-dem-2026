...
from FEMxML.utils_ml_3d import get_data_3d, pickle_load, plot_prection
...
returned_dict = get_data_3d(root_path_list=[
    # '../../simu/Triaxial_Reld/X5_Y5_10_Y3e8_fri0.5_p0.3_rM01_denser_accum_rotation_GOOD/biax_3d_rough_implicit_dem3d_intorder1_numg2000_x5_y5_Y3e8_fri0.5_p0.3_rM01_denser_accum_rotation',
    '../../simu/Triaxial_Reld/biax_3d_rough_implicit_dem3d_intorder1_numg432_x3_y3_Y3e8_fri0.5_p0.3_n1000_rM005_Reld',
...
strain, H_3F, stress, tangent = returned_dict['eps'], returned_dict['H_3D'], returned_dict['sig'], returned_dict['tangent']
# stress, tangent = y_data[:, :3], y_data[:, 3:]
x_data = np.concatenate((strain, H_3F),axis=1)


# net restore
ml_model_path = os.path.join('../FEMxML/triax_ml_1e5/Trial_7_fine', 'X_epsAND3d_Y_D_ddd20_Fourier_noRotate_FEM_DEM_D')
# ml_model_path = os.path.join('../FEMxML/triax_ml_1e5/Trial_30_retrain_final-use', 'X_epsAND3d_Y_sig_dddd20_Fourier_noRotate_FEM_DEM_sig')
...
np.savetxt("tangent_predict_3D.csv", tangent_predict, delimiter=',')
np.savetxt("tangent_3D.csv", tangent, delimiter=',')

# np.savetxt("stress_predict_3D.csv", stress_predict, delimiter=',')
# np.savetxt("stress_3D.csv", stress, delimiter=',')
...
# ----------------------------------------------------------------------------------
markList = ['v', '^', '>', 'o', '<', 'h']
stressLabelList = [11, 12, 13,22,23,33]
tangentlabelList = [1111, 1112, 1122, 1212, 1222, 2222,1113,1313,2323,3333,1133,1333,1322,1323,1332]

...
#### predict mesh 10*20
returned_dict_dem = get_data_series(
    root_path_list=['../../simu/biaxial_0.08/biax_rough_implicit_dem_intorder1_numg800_x10_y20_modified/iteration_gauss'],
    numg=800)
returned_dict_ml = get_data_series(
    root_path_list=[
        '../../simu/biaxial_0.08/biax_rough_implicit_mldem_intorder1_numg800_x10_y20_NNX_epsAND3f_Y_sig_dmd12_Fourier_noRotate_FEM_DEM_sig_savedata_modified/iteration_gauss'],
    numg=800)
...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[86, ::10, 0], stress1[86, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    ax.plot(strain1[87, ::10, 0], stress1[87, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[86, ::10, 0], stress2[86, ::10, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
                    markersize=4, linewidth=1., label='$\sigma_{11}-ML$')
    ax.plot(strain2[87,::10, 0],  stress2[87, ::10, 0] / 1000000, linestyle='-', color='r', marker='o',markerfacecolor='none',markersize=4, linewidth=1.,)

        # ax.plot(_x, _y_hat/ 1000, linestyle='--', color='b', marker='o', markerfacecolor='none', markersize=3,
        #             linewidth=1.5, label='$\sigma_{11}-GRU$')
    ax.legend(loc=(0.2, 0.7), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO87_11_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.set_ylim([-0.016, 0.012])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{12}$',fontsize =12)
    ax.set_ylabel('$\sigma_{12}$ (MPa)',fontsize =12)

    ax.plot(strain1[86, ::10, 1] , stress1[86, ::10, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    ax.plot(strain1[87, ::10, 1], stress1[87, ::10, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[86, ::10, 1] , stress2[86, ::10, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{12}-ML$')
    ax.plot(strain2[87, ::10, 1], stress2[87, ::10, 1] / 1000000, linestyle='-', color='black', marker='o',
            markerfacecolor='None', markersize=4, linewidth=1,)

    ax.legend(loc=(0.3, 0.2), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO87_12_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.xaxis.set_major_locator(x_major_locator)  # 手动设置刻度间隔
    ax.yaxis.set_major_locator(y_major_locator)  # 手动设置刻度间隔
    ax.set_xlim([-0.02, 0.003])
    ax.set_ylim([-0.36, -0.04])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')

    ax.set_xlabel('$\epsilon_{22}$',fontsize =12)
    ax.set_ylabel('$\sigma_{22}$ (MPa)',fontsize =12)

    ax.plot(strain1[86, ::10, 2] , stress1[86, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    ax.plot(strain1[87, ::10, 2], stress1[87, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[86, ::10, 2] , stress2[86, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{22}-ML$')
    ax.plot(strain2[87, ::10, 2], stress2[87, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.32, 0.8), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO87_22_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[417, ::5, 0], stress1[417, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[3, ::5, 0], stress1[3, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[417, ::7, 0], stress2[417, ::7, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    ...
    pyplot.savefig('./NO200_11_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[407, ::5, 1] , stress1[407, ::5, 1]  / 1000000, linestyle='-', color='gold', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[407, ::7, 1] , stress2[407, ::7, 1]  / 1000000, linestyle='-', color='DimGray', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO200_12_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case13(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[127, ::5, 2] , stress1[127, ::5, 2]  / 1000000, linestyle='-', color='#D071FF', linewidth=3.5, label='$\sigma_{13}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[127, ::7, 2] , stress2[127, ::7, 2]  / 1000000, linestyle='-', color='#37FFBC', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1.5, label='$\sigma_{13}-ML$')
    # ax.plot(strain2[3, ::5, 1], stress2[3, ::5, 1] / 1000000, linestyle='-', color='black', marker='o',
    #         markerfacecolor='None', markersize=4, linewidth=1,)

    ax.legend(loc=(0.2, 0.2), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO200_13_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[127, ::5, 3] , stress1[127, ::5, 3] / 1000000, linestyle='-', color='deeppink', linewidth=2.5, label='$\sigma_{22}-DEM$')
    ...
    pyplot.savefig('./NO200_22_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case23(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[117, ::5, 4] , stress1[117, ::5, 4] / 1000000, linestyle='-', color='DarkGray', linewidth=3, label='$\sigma_{23}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[117, ::7, 4] , stress2[117, ::7, 4] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{23}-ML$')
    # ax.plot(strain2[3, ::5, 2], stress2[3, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO200_23_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case33(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[127, ::5, 5] , stress1[127, ::5, 5] / 1000000, linestyle='-', color='#02F8E6', linewidth=3, label='$\sigma_{33}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[127, ::7, 5] , stress2[127, ::7, 5] / 1000000, linestyle='-', color='#C993FF', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=2, label='$\sigma_{33}-ML$')
    # ax.plot(strain2[3, ::5, 2], stress2[3, ::5, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO200_33_coarse_3D.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

...
#### predict mesh 10*20
returned_dict_dem = get_data_series(
    root_path_list=['../../simu/biaxial_Reld/biax_rough_implicit_dem_intorder1_numg800_x10_y20_Reld_St12_2H/iteration_gauss'],
    numg=800)
returned_dict_ml = get_data_series(
    root_path_list=[
...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_ylim(-0.175, 0.025)
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{11}$')
    ax.set_ylabel('$\sigma_{11}(MPa)$')

    ax.plot(strain1[790, ::10, 2], stress1[790, ::10, 1] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}$')
    # ax.plot(strain1[770, ::10, 1], stress1[197, ::10, 1] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,label='$\sigma_{12}')

    # ax.plot(strain1[197, ::10, 2], stress1[197, ::10, 2] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    #                 markersize=4, linewidth=1., label='$\sigma_{22}')
    # ax.plot(strain2[197,::10, 0],  stress2[197, ::10, 0] / 1000000, linestyle='-', color='r', marker='o',markerfacecolor='none',markersize=4, linewidth=1.,)

        # ax.plot(_x, _y_hat/ 1000, linestyle='--', color='b', marker='o', markerfacecolor='none', markersize=3,
        #             linewidth=1.5, label='$\sigma_{11}-GRU$')
    ax.legend(loc=(0.4, 0.2), frameon=True, ncol=2)
    pyplot.savefig('./NO.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[196, ::10, 1] , stress1[196, ::10, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    ax.plot(strain1[197, ::10, 1], stress1[197, ::10, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[196, ::10, 1] , stress2[196, ::10, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{12}-ML$')
    ax.plot(strain2[197, ::10, 1], stress2[197, ::10, 1] / 1000000, linestyle='-', color='black', marker='o',
            markerfacecolor='None', markersize=4, linewidth=1,)

    ax.legend(loc=(0.08, 0.7), frameon=True, ncol=2)
    pyplot.savefig('./NO196_12.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[196, ::10, 2] , stress1[196, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    ax.plot(strain1[197, ::10, 2], stress1[197, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[196, ::10, 2] , stress2[196, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{22}-ML$')
    ax.plot(strain2[197, ::10, 2], stress2[197, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.44, 0.75), frameon=True, ncol=2)
    pyplot.savefig('./NO196_22.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

x = np.arange(0, 200, 1)
indexOfPoint = list(x[196:198])

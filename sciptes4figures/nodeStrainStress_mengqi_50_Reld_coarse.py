...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    pyplot.xlim([-0.0002, 0.0047])
    ax.set_ylim(-0.14, -0.095)
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{11}$')
    ax.set_ylabel('$\sigma_{11}(MPa)$')

    ax.plot(strain1[0, ::10, 0], stress1[50, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[3, ::5, 0], stress1[3, ::5, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[0, ::10, 0], stress2[50, ::10, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    ...
    pyplot.savefig('./NO50_11_Reld_coarse.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.set_ylim([-0.020, 0.004])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{12}$')
    ax.set_ylabel('$\sigma_{12}(MPa)$')

    ax.plot(strain1[0, ::10, 1] , stress1[50, ::10, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[3, ::5, 1], stress1[3, ::5, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[0, ::10, 1] , stress2[50, ::10, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO50_12_Reld_coarse.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    #
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlim([-0.025, 0.001])
    ax.set_ylim([-0.32, -0.12])
    ax.set_xlabel('$\epsilon_{22}$')
    ax.set_ylabel('$\sigma_{22}(MPa)$')

    ax.plot(strain1[0, ::10, 2] , stress1[50, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    # ax.plot(strain1[3, ::5, 2], stress1[3, ::5, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[0, ::10, 2] , stress2[50, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
    ...
    pyplot.savefig('./NO50_22_Reld_coarse.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

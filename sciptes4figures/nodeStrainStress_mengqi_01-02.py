...
#### predict mesh 10*20
returned_dict_dem = get_data_series(
    root_path_list=['../../simu/biaxial_0.08/biax_rough_implicit_dem_intorder1_numg800_x10_y20_Reld15st/iteration_gauss'],
    numg=2592)
returned_dict_ml = get_data_series(
    root_path_list=[
        '../../simu/biaxial_0.08/biax_rough_implicit_mldem_intorder1_numg800_x10_y20_NNX_epsAND3f_Y_sig_dmd12_Fourier_noRotate_FEM_DEM_sig_Reld_15/iteration_gauss'],
    numg=2592)
...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[10, ::10, 0], stress1[10, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    # ax.plot(strain1[1, ::10, 0], stress1[1, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[10, ::10, 0], stress2[10, ::10, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
                    markersize=4, linewidth=1., label='$\sigma_{11}-ML$')
    # ax.plot(strain2[1,::10, 0],  stress2[1, ::10, 0] / 1000000, linestyle='-', color='r', marker='o',markerfacecolor='none',markersize=4, linewidth=1.,)
    ...
    pyplot.savefig('./NO1_11.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_xlim([-0.022, 0.001])
    # ax.set_ylim([-0.18, 0.03])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{12}$')
    ax.set_ylabel('$\sigma_{12}(MPa)$')

    ax.plot(strain1[10, ::10, 1] , stress1[10, ::10, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    # ax.plot(strain1[1, ::10, 1], stress1[1, ::10, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[10, ::10, 1] , stress2[10, ::10, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{12}-ML$')
    # ax.plot(strain2[1, ::10, 1], stress2[1, ::10, 1] / 1000000, linestyle='-', color='black', marker='o',
    #         markerfacecolor='None', markersize=4, linewidth=1,)

    # ax.legend(loc=(0.08, 0.8), frameon=True, ncol=2)
    pyplot.savefig('./NO1_12.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    # ax.set_ylim([-0.9, -0.1])
    # ax.set_xlim([-0.034, 0.002])
    ax.set_xlabel('$\epsilon_{22}$')
    ax.set_ylabel('$\sigma_{22}(MPa)$')

    ax.plot(strain1[10, ::10, 2] , stress1[10, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    # ax.plot(strain1[1, ::10, 2], stress1[1, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[10, ::10, 2] , stress2[10, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{22}-ML$')
    # ax.plot(strain2[1, ::10, 2], stress2[1, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    # ax.legend(loc=(0.15, 0.75), frameon=True, ncol=2)
    pyplot.savefig('./NO1_22.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[78, ::10, 0], stress1[78, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    ax.plot(strain1[79, ::10, 0], stress1[79, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[78, ::10, 0], stress2[78, ::10, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
                    markersize=4, linewidth=1., label='$\sigma_{11}-ML$')
    ax.plot(strain2[79,::10, 0],  stress2[79, ::10, 0] / 1000000, linestyle='-', color='r', marker='o',markerfacecolor='none',markersize=4, linewidth=1.,)

        # ax.plot(_x, _y_hat/ 1000, linestyle='--', color='b', marker='o', markerfacecolor='none', markersize=3,
        #             linewidth=1.5, label='$\sigma_{11}-GRU$')
    ax.legend(loc=(0.1, 0.1), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO78_11_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case12(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    # ax.set_xlim([-0.0102, 0.001])
    # ax.set_ylim([-0.01, 0.035])
    ax.ticklabel_format(style='plain', scilimits=(-1, -1), axis='y')
    ax.set_xlabel('$\epsilon_{12}$',fontsize =12)
    ax.set_ylabel('$\sigma_{12}$ (MPa)',fontsize =12)

    ax.plot(strain1[78, ::10, 1] , stress1[78, ::10, 1]  / 1000000, linestyle='-', color='deeppink', linewidth=3, label='$\sigma_{12}-DEM$')
    ax.plot(strain1[79, ::10, 1], stress1[79, ::10, 1] / 1000000, linestyle='-', color='deeppink', linewidth=3,)
    ax.plot(strain2[78, ::10, 1] , stress2[78, ::10, 1]  / 1000000, linestyle='-', color='black', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{12}-ML$')
    ax.plot(strain2[79, ::10, 1], stress2[79, ::10, 1] / 1000000, linestyle='-', color='black', marker='o',
            markerfacecolor='None', markersize=4, linewidth=1,)

    ax.legend(loc=(0.3, 0.15), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO78_12_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()
...
def plot_case22(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[78, ::10, 2] , stress1[78, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3, label='$\sigma_{22}-DEM$')
    ax.plot(strain1[79, ::10, 2], stress1[79, ::10, 2] / 1000000, linestyle='-', color='y', linewidth=3,)

    ax.plot(strain2[78, ::10, 2] , stress2[78, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o', markerfacecolor='None',
                    markersize=4, linewidth=1, label='$\sigma_{22}-ML$')
    ax.plot(strain2[79, ::10, 2], stress2[79, ::10, 2] / 1000000, linestyle='-', color='dodgerblue', marker='o',markerfacecolor='None',markersize=4, linewidth=1)


    ax.legend(loc=(0.2, 0.8), frameon=True, ncol=2,fontsize =12)
    pyplot.savefig('./NO78_22_new.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

...
#### predict mesh 10*20
# returned_dict_dem = get_data_series(
#     root_path_list=['../../simu/biaxial_0.08/biax_rough_implicit_dem_intorder1_numg800_x10_y20/iteration_gauss'],
#     numg=800)
# returned_dict_ml = get_data_series(
#     root_path_list=[
#         '../../simu/biaxial_0.08/biax_rough_implicit_mldem_intorder1_numg800_x10_y20_NNX_epsAND3f_Y_sig_dmd12_Fourier_noRotate_FEM_DEM_sig_savedata/iteration_gauss'],
#     numg=800)
...
def plot_case11(strain1, strain2, stress1, stress2, indexOfPoint):
    ...
    ax.plot(strain1[196, ::10, 0], stress1[196, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen', linewidth=3,
                    label='$\sigma_{11}-DEM$')
    ax.plot(strain1[197, ::10, 0], stress1[197, ::10, 0] / 1000000, linestyle='-', color='mediumspringgreen',linewidth=3,)

    ax.plot(strain2[196, ::10, 0], stress2[196, ::10, 0] / 1000000, linestyle='-', color='r', marker='o', markerfacecolor='none',
    ...
    pyplot.savefig('./NO196_11.png', format='png', dpi=600, bbox_inches='tight', pad_inches=0.02)
    pyplot.show()
    pyplot.close()

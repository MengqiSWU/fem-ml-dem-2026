...
labelList = ['FEM-DEM-fine', 'Active learning model', 'E', 'F']
pathList = [
    # -----------------------------------------
...
# plt.show()
name = 'topForceCompare_ActiveLearning.png'
plt.savefig(name, dpi=200)
print('Figure is saved as %s' % os.path.join(os.getcwd(), name))

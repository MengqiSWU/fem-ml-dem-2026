...
def initLoad(ID=0):  # where ID identifies the Gauss point location
    if 1:
        ...
        try:
            ...
            print("=================================================================================")
            print(os.getcwd())
            print("Cannot load file %s, it can be generated by examples/FEMxDEM/prepareRVE.py" % fname)
            print("=================================================================================")
            # time.sleep(5)
    else:
...
def initLoad3D(ID=0):  # where ID identifies the Gauss point location
    if 1:
        # All Gauss points import 0.yade.gz resulting in a uniform sample (default)
        try:
            ...
            print("=================================================================================")
            print(os.getcwd())
            print("Cannot load file 0.yade.gz, it can be generated by examples/FEMxDEM/prepareRVE3D.py")
            print("=================================================================================")
            time.sleep(5)
    else:
        # Otherwise load different packings to generate random field
...
def shear3D(param):
    ...
    Omega().stringToScene(param[0])
    ns = int(max(1e5 * numpy.max(numpy.abs(param[1])), 2))
    dstrain = utils.Matrix3(param[1][0], param[1][1], param[1][2], param[1][3], param[1][4], param[1][5], param[1][6],
                            param[1][7], param[1][8])
    Omega().cell.velGrad = dstrain / (ns * Omega().dt)
    Omega().run(ns, True)
    Omega().cell.velGrad = utils.Matrix3.Zero
...
def getStressAndTangent3D(scene):
    ...
    t[1][2][0][2] = t[1][2][2][0] = t[2][1][0][2] = t[2][1][2][0] = t[0][2][1][2] = t[2][0][1][2] = t[0][2][2][1] = \
    t[2][0][2][1] = st[1][3, 4]
    t[1][2][0][1] = t[1][2][1][0] = t[2][1][0][1] = t[2][1][1][0] = t[0][1][1][2] = t[1][0][1][2] = t[0][1][2][1] = \
    t[1][0][2][1] = st[1][3, 5]
    t[0][2][0][2] = t[2][0][0][2] = t[0][2][2][0] = t[2][0][2][0] = st[1][4, 4]
    t[0][2][0][1] = t[0][2][1][0] = t[2][0][0][1] = t[2][0][1][0] = t[0][1][0][2] = t[1][0][0][2] = t[0][1][2][0] = \
    t[1][0][2][0] = st[1][4, 5]
    t[0][1][0][1] = t[0][1][1][0] = t[1][0][0][1] = t[1][0][1][0] = st[1][5, 5]
